...
export default function VideoBanner() {
  ...
  return (
    <section
      id="video-banner"
      className="relative min-h-[460px] sm:min-h-[540px] flex items-center justify-center overflow-hidden my-10 sm:my-16 rounded-3xl mx-4 sm:mx-6 lg:mx-auto max-w-7xl shadow-2xl"
    >
      ...
      >
        <source src="/WhatsApp Video 2026-08-25 at 22.37.07.mp4" type="video/mp4" />
      </video>

      {/* Dark overlay for text readability */}
      <div className="absolute inset-0 bg-[#040914]/65" />
